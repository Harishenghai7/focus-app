...
/**
 * IncomingCallListener - Listens for incoming calls and shows modal.
 * @component
 * @param {Object} user - Current user object
 * @returns {React.ReactElement}
 */
const IncomingCallListener = React.memo(function IncomingCallListener({ user }) {
...
IncomingCallListener.displayName = 'IncomingCallListener';
IncomingCallListener.propTypes = {

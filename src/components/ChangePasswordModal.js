...
/**
 * ChangePasswordModal - Modal for changing user password with strength validation.
 * @component
 * @param {boolean} isOpen - Whether modal is open
 * @param {function} onClose - Handler to close modal
 * @param {function} onSuccess - Handler for successful password change
 * @returns {React.ReactElement}
 */
const ChangePasswordModal = React.memo(function ChangePasswordModal({ isOpen, onClose, onSuccess }) {

...
/**
 * IncomingCallModal - Modal for incoming call notification.
 * @component
 * @param {Object} call - Call object
 * @param {function} onAccept - Handler for accepting call
 * @param {function} onDecline - Handler for declining call
 * @returns {React.ReactElement}
 */
const IncomingCallModal = React.memo(function IncomingCallModal({ call, onAccept, onDecline }) {

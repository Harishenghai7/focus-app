/**
 * useInstagramLikeInteractions Hook
 * @hook
 * @param {string} postId - Instagram post ID
 * @returns {Object} { liked, toggleLike, error }
 * @example
 * const { liked, toggleLike } = useInstagramLikeInteractions(postId);
 */
import { useState, useEffect, useCallback, useRef } from 'react';
import { supabase } from '../supabaseClient';

export function useInstagramLikeInteractions(contentId, contentType, user) {

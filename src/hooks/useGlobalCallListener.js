        ...
        try {
            ...
            try {
                ...
                const response = await fetch(
                    `${supabaseUrl}/rest/v1/profiles?id=eq.${callRecord.caller_id}&select=id,username,full_name,avatar_url,is_verified,trust_score`,
                    {
                        headers: {
...
const playRingtone = () => {
    try {
        ...
        audio.play().catch(err => {
          // Ringtone play failed - likely autoplay prevention
        });

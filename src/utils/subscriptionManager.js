...
class SubscriptionManager {
  ...
  logStats() {
    ...
    // console.groupCollapsed(`[SubscriptionManager] Stats (${stats.total}/${stats.max})`);
    // console.log(`Utilization: ${stats.utilizationPercent.toFixed(2)}%`);
    // console.log(`Batch Queue: ${stats.batchQueueSize}`);
    // console.table(Object.fromEntries(stats.channels));
    // console.table(Object.fromEntries(stats.components));
    // console.table(Object.fromEntries(stats.priorities));
    // console.groupEnd();
  }
}

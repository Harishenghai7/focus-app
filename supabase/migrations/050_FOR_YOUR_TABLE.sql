-- ═══════════════════════════════════════════════════════════════════════════════
-- 🔱 TRUST SHIELD - CUSTOM SQL FOR YOUR TABLE STRUCTURE
-- Based on your actual profiles table columns
-- ═══════════════════════════════════════════════════════════════════════════════

-- ============================================================================
-- ADD ONLY MISSING COLUMNS (your table already has some)
-- ============================================================================

-- These columns are MISSING and need to be added:
...
DECLARE
    v_existing_id UUID;
BEGIN
    -- Check name + DOB (using your existing date_of_birth column)
...
-- Function 3: Finalize verification
...
BEGIN
    ...
    -- Update all verification fields (using your existing columns)
    UPDATE profiles SET

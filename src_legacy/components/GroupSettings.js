...
/**
 * GroupSettings - Settings panel for a group chat.
 * @component
 * @param {Object} groupInfo - Group info object
 * @param {boolean} isAdmin - Is current user admin
 * @param {function} onClose - Handler to close settings
 * @param {function} onUpdate - Handler for group update
 * @returns {React.ReactElement}
 */
const GroupSettings = React.memo(function GroupSettings({ groupInfo, isAdmin, onClose, onUpdate }) {

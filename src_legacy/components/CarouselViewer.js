...
/**
 * CarouselViewer - Displays a carousel of media items with keyboard navigation.
 * @component
 * @param {string[]} mediaUrls - Array of media URLs
 * @param {string[]} mediaTypes - Array of media types
 * @param {boolean} [autoPlay] - Enable auto play
 * @param {boolean} [showControls] - Show navigation controls
 * @param {function} [onIndexChange] - Callback for index change
 * @returns {React.ReactElement}
 */
const CarouselViewer = React.memo(function CarouselViewer({ 
  mediaUrls = [], 
  mediaTypes = [], 
  autoPlay = false, 
  showControls = true,
  ...
  if (!mediaUrls || mediaUrls.length === 0) {
    return (
      <div className={styles.carouselViewer + ' ' + styles.carouselError}>
  ...
  return (
    <div className={styles.carouselViewer}>
          ...
          >
            {currentMediaType === 'video' ? (
              <video
                src={currentMediaUrl}
                controls
                className={styles.carouselMedia + ' ' + styles.carouselVideo}
              ...
              <LazyImage
                ...
                className={styles.carouselMedia + ' ' + styles.carouselImage}
                threshold={0.1}
                rootMargin="50px"
              />
            )}

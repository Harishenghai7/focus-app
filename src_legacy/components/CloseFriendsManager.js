...
import styles from './CloseFriendsManager.module.css';

/**
 * CloseFriendsManager - Manage user's close friends list.
 * @component
 * @param {Object} user - Current user object
 * @param {function} onClose - Handler to close manager
 * @returns {React.ReactElement}
 */
const CloseFriendsManager = React.memo(function CloseFriendsManager({ user, onClose }) {
...
CloseFriendsManager.displayName = 'CloseFriendsManager';
CloseFriendsManager.propTypes = {

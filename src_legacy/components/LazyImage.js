...
/**
 * LazyImage - Lazy loads images using Intersection Observer with blur-up placeholder.
 * @component
 ...
 * @param {string} [rootMargin] - Intersection root margin
 * @param {function} [onLoad] - Handler for image load

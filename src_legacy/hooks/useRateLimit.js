 ...
 * useRateLimit Hook
 * @hook
 * @param {number} limit - Max actions per interval
 * @param {number} interval - Interval in ms
 * @returns {Object} { canRun, reset }
 * @example
 * const { canRun } = useSimpleRateLimit(5, 1000);
 */
export function useSimpleRateLimit(limit, interval) {
